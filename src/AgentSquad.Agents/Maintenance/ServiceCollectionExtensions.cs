...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddMaintenanceSquad(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddHttpClient("TavilySecurityResearch", client => client.Timeout = TimeSpan.FromSeconds(15));
        ...
        services.AddSingleton<ITavilySecurityResearch, TavilySecurityResearch>();
